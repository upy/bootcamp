...
from products.filters import ProductFilter, CategoryFilter, StockFilter, \
    PriceFilter
from products.models import Product, Category, Stock, Price
from products.serializers import ProductSerializer, CategorySerializer, \
    ProductDetailedSerializer, StockSerializer, StockDetailedSerializer, \
    PriceSerializer, PriceDetailedSerializer
