...
class Basket(BaseAbstractModel):
    ...
    status = models.CharField(choices=enums.StatusChoices.choices, verbose_name=_("Status"), max_length=20)
...
class BasketItem(BaseAbstractModel):
    ...
    def __str__(self):
        return f"{self.product} ({self.quantity}) in {self.basket} basket"
