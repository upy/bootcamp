    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(message="Postal Code must be entered in the format: '1234567'. Up to 7 digits allowed.", regex='^[0-9]+$')], verbose_name='Post Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modified at')),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('processing', 'Processing'), ('shipped', 'Shipped'), ('delivered', 'Delivered'), ('canceled', 'Canceled')], max_length=20, verbose_name='Order Status')),
                ...
                ('billing_address', models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.PROTECT, to='orders.billingaddress', verbose_name='Billing Address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iban', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(message='Enter a valid IBAN number.', regex='^[A-Z]{2}[0-9]{2}[A-Z0-9]{4}[0-9]{7}([A-Z0-9]?){0,16}$')], verbose_name='IBAN')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.PROTECT, to='orders.shippingaddress', verbose_name='Shipping Address'),
        ),
    ]
